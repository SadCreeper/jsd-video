<div class="col-md-4 col-xs-6 z-padding-phone" style="margin-bottom:30px">
    ...
    <div class="hidden-lg hidden-md hidden-sm">
        <p class="z-img-bottom-bar"><span class="glyphicon glyphicon-play-circle"></span> {{ $article->view }} <span class="glyphicon glyphicon-edit" style="margin-left:5px"></span> {{ $article->comment }}</p>
